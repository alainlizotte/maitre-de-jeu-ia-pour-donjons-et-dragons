...
ARMES: list[dict[str, Any]] = [
    ...
    {"nom": "Bâton",                  "groupe": "simple",   "distance": False, "degats": "1d6",      "cout": 0},
    {"nom": "Matraque",               "groupe": "simple",   "distance": False, "degats": "1d6",      "cout": 0},
    {"nom": "Dague",                  "groupe": "simple",   "distance": True,  "degats": "1d4",      "cout": 2},
    {"nom": "Masse d'armes légère",   "groupe": "simple",   "distance": False, "degats": "1d6",      "cout": 8},
    {"nom": "Faucille",               "groupe": "simple",   "distance": False, "degats": "1d6",      "cout": 8},
    {"nom": "Lance courte",           "groupe": "simple",   "distance": True,  "degats": "1d6",      "cout": 1},
    # Simples, distance
    {"nom": "Javeline",               "groupe": "simple",   "distance": True,  "degats": "1d6",      "cout": 1},
    {"nom": "Fronde",                 "groupe": "simple",   "distance": True,  "degats": "1d4",      "cout": 0},
    {"nom": "Arbalète légère",        "groupe": "simple",   "distance": True,  "degats": "1d8",      "cout": 35},
    {"nom": "Arbalète lourde",        "groupe": "simple",   "distance": True,  "degats": "1d10",     "cout": 50},
    {"nom": "Lance",                  "groupe": "simple",   "distance": True,  "degats": "1d8",      "cout": 2},
    # Martiales, corps à corps
    {"nom": "Épée longue",            "groupe": "martiale", "distance": False, "degats": "1d8",      "cout": 15},
    {"nom": "Épée courte",            "groupe": "martiale", "distance": False, "degats": "1d6",      "cout": 10},
    {"nom": "Rapière",                "groupe": "martiale", "distance": False, "degats": "1d6",      "cout": 20},
    {"nom": "Hache d'arme",           "groupe": "martiale", "distance": False, "degats": "1d8",      "cout": 30},
    {"nom": "Hache à deux mains",     "groupe": "martiale", "distance": False, "degats": "1d12",     "cout": 40},
    {"nom": "Espadon",                "groupe": "martiale", "distance": False, "degats": "2d6",      "cout": 50},
    {"nom": "Masse d'armes lourde",   "groupe": "martiale", "distance": False, "degats": "1d8",      "cout": 12},
    {"nom": "Fléau d'armes",          "groupe": "martiale", "distance": False, "degats": "1d8",      "cout": 15},
    {"nom": "Marteau de guerre",      "groupe": "martiale", "distance": False, "degats": "1d8",      "cout": 12},
    {"nom": "Glaive",                 "groupe": "martiale", "distance": False, "degats": "1d10",     "cout": 8},
    {"nom": "Hallebarde",             "groupe": "martiale", "distance": False, "degats": "1d10",     "cout": 10},
    # Martiales, distance
    {"nom": "Arc court",              "groupe": "martiale", "distance": True,  "degats": "1d6",      "cout": 30},
    {"nom": "Arc long",               "groupe": "martiale", "distance": True,  "degats": "1d8",      "cout": 75},
]
...
ARMURES: list[dict[str, Any]] = [
    {"nom": "Armure rembourrée",    "categorie": "Legere",  "ca": 1, "dex_max": 8, "malus": 0, "cout": 5},
    {"nom": "Armure de cuir",       "categorie": "Legere",  "ca": 2, "dex_max": 6, "malus": 0, "cout": 10},
    {"nom": "Cuir clouté",          "categorie": "Legere",  "ca": 3, "dex_max": 5, "malus": 1, "cout": 25},
    {"nom": "Chemise de mailles",   "categorie": "Moyenne", "ca": 4, "dex_max": 4, "malus": 2, "cout": 100},
    {"nom": "Cuir épais",           "categorie": "Moyenne", "ca": 3, "dex_max": 4, "malus": 3, "cout": 15},
    {"nom": "Armure d'écailles",    "categorie": "Moyenne", "ca": 4, "dex_max": 3, "malus": 4, "cout": 50},
    {"nom": "Cotte de mailles",     "categorie": "Lourde",  "ca": 5, "dex_max": 2, "malus": 5, "cout": 150},
    {"nom": "Plastron",             "categorie": "Lourde",  "ca": 5, "dex_max": 3, "malus": 4, "cout": 200},
    {"nom": "Harnois complet",      "categorie": "Lourde",  "ca": 8, "dex_max": 1, "malus": 6, "cout": 1500},
    {"nom": "Targe",                "categorie": "Bouclier", "ca": 1, "dex_max": None, "malus": 1, "cout": 15},
    {"nom": "Bouclier bois léger",  "categorie": "Bouclier", "ca": 1, "dex_max": None, "malus": 1, "cout": 3},
    {"nom": "Bouclier bois lourd",  "categorie": "Bouclier", "ca": 2, "dex_max": None, "malus": 2, "cout": 7},
]
...
EQUIPEMENT: list[dict[str, Any]] = [
    {"nom": "Sac à dos",              "cout": 2},
    {"nom": "Sac de couchage",        "cout": 0},
    {"nom": "Lit de camp",            "cout": 0},
    {"nom": "Outre à eau",            "cout": 0},
    {"nom": "Corde de chanvre (15 m)", "cout": 1},
    {"nom": "Torche",                 "cout": 0},
    {"nom": "Silex et amorce",        "cout": 1},
    {"nom": "Lanterne à capuchon",    "cout": 7},
    {"nom": "Huile (pinte)",          "cout": 0},
    {"nom": "Rations journalières",   "cout": 1},
    {"nom": "Gibecière",              "cout": 2},
    {"nom": "Kit premiers secours",   "cout": 1},
    {"nom": "Grappin et corde",       "cout": 1},
    {"nom": "Flèches (20)",           "cout": 1},
    {"nom": "Carreaux (10)",          "cout": 1},
    {"nom": "Pierre à aiguiser",      "cout": 0},
    {"nom": "Savon",                  "cout": 0},
    {"nom": "Craie",                  "cout": 0},
]
