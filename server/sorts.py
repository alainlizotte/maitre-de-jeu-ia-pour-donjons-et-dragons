...
_E: dict[str, list[tuple[int, ...]]] = {
    ...
    "Sorcier": [
        # Tables PHB 3.5 officielles — 2e cycle de sorts dès le niv.4,
        # 3e dès le niv.6, 4e dès le niv.9, 5e dès le niv.11, 6e dès le
        # niv.14, 7e dès le niv.17, 8e niv.19, 9e niv.20. L'ancienne table
        # retardait le Sorcier d'un niveau de perso sur les cycles 2-3
        # (incohérent avec CONNUS ci-dessous, déjà conforme : « 6,4,2 »
        # au niv.4 = 2 sorts de 2e niveau CONNUS mais incastables).
        (5, 3), (6, 4), (6, 5), (6, 6, 2), (6, 6, 3), (6, 6, 6, 1),
        (6, 6, 6, 3), (6, 6, 6, 4), (6, 6, 6, 6, 1), (6, 6, 6, 6, 3),
        (6, 6, 6, 6, 6, 1), (6, 6, 6, 6, 6, 3), (6, 6, 6, 6, 6, 4),
        (6, 6, 6, 6, 6, 6, 1), (6, 6, 6, 6, 6, 6, 3), (6, 6, 6, 6, 6, 6, 4),
        (6, 6, 6, 6, 6, 6, 6, 1), (6, 6, 6, 6, 6, 6, 6, 3),
        (6, 6, 6, 6, 6, 6, 6, 4), (6, 6, 6, 6, 6, 6, 6, 6, 6, 3),
    ],
    "Barde": [
